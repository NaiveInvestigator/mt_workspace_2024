...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /home/mtbase/catkin_ws/src/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /home/mtbase/catkin_ws/devel)
  ...
  set(realsense2_description_INSTALL_PREFIX /home/mtbase/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mtbase/catkin_ws/src/realsense2_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT realsense2_description_NUM_DUMMY_TARGETS)
      set(realsense2_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::realsense2_description::wrapped-linker-option${realsense2_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR realsense2_description_NUM_DUMMY_TARGETS "${realsense2_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::realsense2_description::wrapped-linker-option${realsense2_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND realsense2_description_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(realsense2_description_EXPORTED_TARGETS ${${realsense2_description_dep}_EXPORTED_TARGETS})
endforeach()
