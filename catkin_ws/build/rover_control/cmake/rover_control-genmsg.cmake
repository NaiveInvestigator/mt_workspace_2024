...
set(MSG_I_FLAGS "-Irover_control:/home/mtbase/catkin_ws/src/rover_control/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/mtbase/catkin_ws/src/rover_control/msg/ArucoInfo.msg" NAME_WE)
add_custom_target(_rover_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rover_control" "/home/mtbase/catkin_ws/src/rover_control/msg/ArucoInfo.msg" ""
)

get_filename_component(_filename "/home/mtbase/catkin_ws/src/rover_control/msg/ControlStatus.msg" NAME_WE)
add_custom_target(_rover_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rover_control" "/home/mtbase/catkin_ws/src/rover_control/msg/ControlStatus.msg" ""
)
...
### Generating Module File
_generate_module_eus(rover_control
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rover_control
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(rover_control_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(rover_control_generate_messages rover_control_generate_messages_eus)
...
add_dependencies(rover_control_geneus rover_control_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rover_control_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(rover_control
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rover_control
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(rover_control_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(rover_control_generate_messages rover_control_generate_messages_nodejs)
...
add_dependencies(rover_control_gennodejs rover_control_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rover_control_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rover_control)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/rover_control
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(rover_control_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rover_control)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/rover_control
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(rover_control_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rover_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rover_control\")")
  # install generated code
  install(
