...
def move():
    ...
    for i_button, value_button in enumerate(buttons):
        if value_button > 0 and not is_pressed_button[i_button]:
            ...
            key = str(BUTTONS[i_button]).capitalize()
