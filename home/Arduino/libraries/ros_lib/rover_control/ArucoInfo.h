#ifndef _ROS_rover_control_ArucoInfo_h
#define _ROS_rover_control_ArucoInfo_h
...
namespace rover_control
{
  ...
  class ArucoInfo : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "rover_control/ArucoInfo"; };
    virtual const char * getMD5() override { return "2fc9308a0b3197eeb33075d3be520061"; };
